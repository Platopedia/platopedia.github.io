...
<head>
    ...
    <style>
        ...
        .announcement-strip {
            width: 100%;
            background: linear-gradient(90deg, #C30000, #353A40); /* Gradient background for visual appeal */
            ...
            border-top: 2px solid #353A40; /* Add a border on top for a polished look */
