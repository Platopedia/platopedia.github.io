var content_wrapper, content_count;
...
function on_ready ( ) {
    ...
    var content_contents = content_wrapper.find( '.content-contents' );
    var content_carousel = content_wrapper.find( '.content-carousel' );
    var content_collapse = content_wrapper.find( '.content-collapse' );
    var content_webpage  = content_wrapper.find( '.content-webpage'  );
    var content_image    = content_wrapper.find( '.content-image'    );
    var content_table    = content_wrapper.find( '.content-table'    );
